...
axios.defaults.baseURL = 'http://localhost:5258/api/';
...
const Catalog = {
  list: () => requests.get('Products/getAllProducts'),
...
const Basket = {
  ...
  removeItem: (productId: number, quantity = 1) => requests.delete(`basket/removeItemFromBasket?productId=${productId}&quantity=${quantity}`),
}
